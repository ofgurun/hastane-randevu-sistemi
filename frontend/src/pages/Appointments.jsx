...
export default function Appointments() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (active) setError("Randevular yüklenemedi. Lütfen tekrar deneyin.");
      } finally {
  ...
  const onCancel = async (id) => {
    ...
    try {
      ...
      setSuccess("Randevunuz iptal edildi.");
    } catch (err) {
      setError(err.response?.data?.message || "Randevu iptal edilemedi. Lütfen tekrar deneyin.");
    } finally {
      setCancelingId(null);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-4xl px-4 py-8">
        ...
        <p className="mt-1 text-slate-500">Aktif randevularınızı görüntüleyin ve iptal edin.</p>
        ...
        {error && (
          <div className="mt-4 flex items-center gap-2 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-red-600">
